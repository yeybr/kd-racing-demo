...
export default {
  ...
  methods: {
    preload (phaser) {
        phaser.load.image('background', 'static/crossy-rpg/assets/background.png');
        phaser.load.image('dragon', 'static/crossy-rpg/assets/dragon.png');
        phaser.load.image('player', 'static/crossy-rpg/assets/player.png');
        phaser.load.image('treasure', 'static/crossy-rpg/assets/treasure.png');
    ...
    create(phaser) {
      ...
      //                 });
      // background
        let bg = phaser.add.sprite(0, 0, 'background');

        // change origin to the top-left of the sprite
        bg.setOrigin(0, 0);

        // player
        phaser.player = phaser.add.sprite(40, phaser.sys.game.config.height / 2, 'player');

        // scale down
        phaser.player.setScale(0.5);

        // goal
        phaser.treasure = phaser.add.sprite(phaser.sys.game.config.width - 80, phaser.sys.game.config.height / 2, 'treasure');
